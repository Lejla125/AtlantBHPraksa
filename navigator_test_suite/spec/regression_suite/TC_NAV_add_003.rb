...
#This test script includes more test cases. It enters invalid phone numbers, weblinks and working hours.
 ...
 describe "NEGATIVE TEST CASE: Add new full invalid data place" do
   ...
   include_context "Click tag text and add working hours",tag_text,true
   include_context "Enter additional place info",true,telephone_number,mobile_number,fax_number,website_url,facebook_url,instagram_url,wikipedia_url,youtube_url,email_address,twitter_url,forsquare_url,tripadvisor_url,instagram_hashtag,wifi_password,wifi_name,place_comment
   ...
   context "Check if the social networks url text fields and telephone number fields have been validated" do
     it "checks if all social media links fields and telephone fields have red borders" do
       @form.new_scroll("//input[@id=\"poi_web\"]","up")
